...
export default function App() {
  ...
  const { dockPosition, setDockPosition, effectiveDockPosition } = useTerminalPanelPreference()
  ...
  return (
    <>
      <div className="flex h-screen flex-col overflow-hidden bg-[var(--background)] text-[var(--foreground)]">
        ...
        <div className={`flex min-h-0 flex-1 ${effectiveDockPosition === 'bottom' ? 'flex-col' : 'flex-row'}`}>
        <div className={`app-body flex min-h-0 flex-1 pb-8 ${effectiveDockPosition !== 'bottom' ? 'min-w-0' : ''}`}>
          {sidebarCollapsed ? (
          ...
          <TerminalPanel
            ...
            effectiveDockPosition={effectiveDockPosition}

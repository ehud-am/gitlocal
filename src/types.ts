...
export type LocalPathType = 'file' | 'directory' | 'missing' | 'unsupported'

export interface LocalPathClassification {
  inputPath: string
...
export type FileContentType = 'markdown' | 'json' | 'text' | 'image' | 'binary' | 'svg' | 'pdf'
